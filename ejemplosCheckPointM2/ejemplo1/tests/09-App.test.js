...
jest.mock("../src/components/TeamDetail/TeamDetail", () => () => <></>);
jest.mock("../src/components/TeamsCard/TeamsCard", () => () => <></>);
jest.mock("../src/components/Nav/Nav", () => () => <></>);
jest.mock("../src/components/CreateTeam/CreateTeam", () => () => <></>);
jest.mock("../src/components/Teams/Teams", () => () => <></>);
